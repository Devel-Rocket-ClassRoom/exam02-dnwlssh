...
public:
    ...
    static const std::vector<AdditionalRow>& GetFirstPool() {
        static const std::vector<AdditionalRow> pool = {
            ...
            { L"크리티컬 확률 : +13%", StatType::CRate, 13, 5.1282 }, // StatType에 Crit가 없으면 적절히 대체 가능합니다.
            ...
            { L"캐릭터 기준 9레벨 당 STR : +2", StatType::STR, 2, 5.1282 }, { L"캐릭터 기준 9레벨 당 DEX : +2", StatType::DEX, 2, 5.1282 },
            { L"캐릭터 기준 9레벨 당 INT : +2", StatType::INT, 2, 5.1282 }, { L"캐릭터 기준 9레벨 당 LUK : +2", StatType::LUK, 2, 5.1282 },
    ...
    static const std::vector<AdditionalRow>& GetSecondPool() {
        static const std::vector<AdditionalRow> pool = {
            ...
            { L"캐릭터 기준 9레벨 당 STR : +1", StatType::STR, 1, 4.6280 }, { L"캐릭터 기준 9레벨 당 DEX : +1", StatType::DEX, 1, 4.6280 },
            { L"캐릭터 기준 9레벨 당 INT : +1", StatType::INT, 1, 4.6280 }, { L"캐릭터 기준 9레벨 당 LUK : +1", StatType::LUK, 1, 4.6280 },
            ...
            { L"올스탯 : +10%", StatType::AllStat, 10, 0.02551 }, { L"캐릭터 기준 9레벨 당 STR : +2", StatType::STR, 2, 0.02551 },
            { L"캐릭터 기준 9레벨 당 DEX : +2", StatType::DEX, 2, 0.02551 }, { L"캐릭터 기준 9레벨 당 INT : +2", StatType::INT, 2, 0.02551 },
            { L"캐릭터 기준 9레벨 당 LUK : +2", StatType::LUK, 2, 0.02551 }, { L"공격력 : +32", StatType::ATT, 32, 0.01276 },
